...
#
# This script:
# 1) enriches an existing fold directory with FA mask columns from a ready CSV
# 2) optionally rewrites mask paths to a different suffix such as _masks_v2.npy
# 3) runs the canonical 45-job sweep:
#    - 3 experiment families
#    - 5 folds
#    - 3 seeds
#
# Example:
# bash scripts/run_zone_masked_canonical_sweep.sh \
...
#   --input_folds_root "fold" \
#   --prepared_folds_root "fold_masked_canonical_v2" \
...
FOLDS_CSV="0,1,2,3,4"
SEEDS_CSV="0,1,2"
ROOT_OUTPUT_DIR="output_zone_masked_canonical_v2"
LOG_DIR="logs/zone_masked_canonical_v2"
IMAGE_SIZE=224
ZONE_CROP_SIZE=224
