...
# Sweep ResNet50 binary configs across folds 0..4.
...
#
# Example:
# bash scripts/run_resnet50_binary_sweep.sh \
...
SLOTS_PER_GPU=4
FOLDS_CSV="0,1,2,3,4"
ROOT_OUTPUT_DIR="output_resnet50_sweep_binary"
LOG_DIR="logs/resnet50_sweep_binary"
