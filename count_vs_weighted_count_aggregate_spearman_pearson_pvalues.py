...
if __name__ == "__main__":
    ...
    # csv_file = "CombinedExtNebTests.csv"
    # csv_file = "output_ext_test/final_finetune_resnet50_pretraining_swav_CE_loss_unweighted_batch_64_lr_0.001_decay_1e-05_10_10_1_1e-05_epochs_100_hflip_seed_0/test.csv"  # ← ground-truth, same format as before
    csv_file = "output_nebraska/final_finetune_resnet50_pretraining_swav_CE_loss_unweighted_batch_64_lr_0.001_decay_1e-05_10_10_1_1e-05_epochs_100_hflip_seed_0/test.csv"  # ← ground-truth, same format as before
    out_folder = "Count (GT) nebraska"
    ...
    # out_folder = "Count (GT) for aggregate severity diagnosis (Combined ExtNeb)"
    # out_folder = "Count (GT) ext test"
    # 3) Run aggregator: skip groups with fewer than 4 distinct dates
    results_df, meta_stats = aggregate_correlations_and_pvalues(
        df_full=df,
        min_dates=4,
        # output_folder="Count (GT) for aggregate severity diagnosis (Combined ExtNeb)"
